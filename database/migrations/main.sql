...
ALTER TABLE posts ADD COLUMN IF NOT EXISTS slug VARCHAR(150);
...
ALTER TABLE posts ADD COLUMN IF NOT EXISTS image VARCHAR(150);
ALTER TABLE posts ADD COLUMN IF NOT EXISTS image_path VARCHAR(150);
